...
import DeleteAccount from '@gno/screens/delete-account';
import DeleteConfirm from '@gno/screens/delete-account/confirm';
...
export type RouterWelcomeStack = {
  ...
  DeleteConfirm: { accountName: string };
};
...
const SignedOutStackScreen = () => (
  <Stack.Navigator initialRouteName='WalletCreate'>
    <Stack.Group screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen name={RoutePath.DeleteAccount} component={DeleteAccount}></Stack.Screen>
      <Stack.Screen name={RoutePath.DeleteConfirm} component={DeleteConfirm}></Stack.Screen>
